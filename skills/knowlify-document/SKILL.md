...
8. Author the approved missing knowls in small, disjoint batches. Put the definition first, link prerequisites semantically, give one clarifying example, and state setting-sensitive warnings. Prefer 100–220 words unless the definition genuinely needs more.
