...
(function () {
  ...
  function renderGraph() {
    ...
    status.textContent = `${cluster ? `${cluster.title}: ${cluster.members.size} concepts in this cluster. ` : ""}Showing ${levels.size} concepts and ${visibleEdges.length} prerequisite links around ${nodes.get(focusId).title}.${layoutDescription}${omittedMessage}`;
  ...
  function setMode(value) {
    ...
    clusterGroups = mode === "neighborhood" ? [] : GraphModel.clusters(nodes, allEdges, mode);
  }
