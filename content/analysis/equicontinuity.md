...
Equicontinuity is a compactness-type condition for families of functions. Together with pointwise boundedness it leads to the Arzelà–Ascoli theorem (subsequence compactness in $C(K)$ when $K$ is compact).
