...
Let $f$ be a real- (or complex-) valued function defined on an interval containing $a\in\mathbb{R}$, and assume that $f^{(j)}(a)$ exists for $0\le j\le k$. The **Taylor polynomial of degree $k$ of $f$ at $a$** is
$$
