...
Linear maps are the morphisms in linear algebra; in analysis they model derivatives (as best linear approximations) and bounded linear operators (when norms are present).
