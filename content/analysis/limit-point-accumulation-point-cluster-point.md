...
Limit points are the points that can be approached by elements of $A$ distinct from the point itself. They determine closedness (a set is closed iff it contains all its limit points) and appear throughout analysis.
