...
Let $(X,d_X)$ and $(Y,d_Y)$ be metric spaces, let $E\subseteq X$, and let $f:E\to Y$. The function $f$ is **continuous at a point** $x_0\in E$ if
...
Equivalently, $f$ is continuous at $x_0$ iff $\lim_{x\to x_0} f(x)=f(x_0)$.
