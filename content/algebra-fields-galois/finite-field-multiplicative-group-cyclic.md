...
\]
is a {{</* knowl id="group" text="group" */>}} that is {{</* knowl id="finite-field-multiplicative-cyclic" text="cyclic" */>}} of order \(q-1\). In particular, there exists a **primitive element** \(g\in \mathbb{F}_q^\times\) such that \(\mathbb{F}_q^\times=\langle g\rangle\).
