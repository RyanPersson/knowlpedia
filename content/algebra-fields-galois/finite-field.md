...
The multiplicative group \(\mathbb{F}_q^\times\) is cyclic (see {{< knowl id="finite-field-multiplicative-group-cyclic" text="finite field multiplicative group is cyclic" >}}), and \(\mathrm{char}(\mathbb{F}_q)=p\) (see {{< knowl id="characteristic-zero-or-prime" text="characteristic" >}}).
