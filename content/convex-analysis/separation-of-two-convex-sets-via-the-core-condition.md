...
Let $X$ be a real {{< knowl id="vector-space" text="vector space" >}} and let $\Omega_1,\Omega_2\subset X$ be nonempty {{< knowl id="convex-set" text="convex sets" >}}. Assume {{< knowl id="algebraic-interior-core" text="core(Ω₁)" >}}$\neq\emptyset$ and
$$
