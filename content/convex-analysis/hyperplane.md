...
Let $X$ be a {{< knowl id="vector-space" text="vector space" >}}. An {{< knowl id="affine-set" text="affine set" >}} $\Omega\subset X$ is called a **hyperplane** if it has {{< knowl id="codimension" text="codimension" >}} one.
