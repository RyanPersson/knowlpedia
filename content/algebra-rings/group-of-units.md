...
description: "The multiplicative group consisting of all units in a unital ring."
---
...
\]
with operation given by multiplication in $R$. This is a {{< knowl id="group" text="group" >}}, and it consists exactly of the {{< knowl id="unit" text="units" >}} of $R$.
