...
define inverse, inclusion-preserving bijections between the set of {{</* knowl id="submodule" text="submodules" */>}} of \(M\) containing \(N\) and the set of submodules of the {{</* knowl id="quotient-module" text="quotient module" */>}} \(M/N\). The inverse image operation uses the notion of {{</* knowl id="preimage" text="preimage" */>}} under \(\pi\).
