...
Let $R$ be an {{</* knowl id="integral-domain" text="integral domain" */>}} and $M$ an $R$-module. The module $M$ is **torsion-free** if its only {{</* knowl id="torsion-element" text="torsion element" */>}} is $0$, i.e. if $rm=0$ with $0\ne r\in R$ forces $m=0$.
