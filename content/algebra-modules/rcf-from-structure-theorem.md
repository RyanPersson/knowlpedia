...
This is an application of the {{</* knowl id="structure-theorem-pid" text="structure theorem over a PID" */>}} to the {{</* knowl id="polynomial-ring" text="polynomial ring" */>}} $F[x]$ (with $F$ a {{</* knowl id="field" text="field" */>}}), after encoding a {{</* knowl id="linear-map" text="linear map" */>}} on a {{</* knowl id="vector-space" text="vector space" */>}} as a {{</* knowl id="module" text="module" */>}} structure; see {{</* knowl id="rational-canonical-form-theorem" text="rational canonical form theorem" */>}}.
