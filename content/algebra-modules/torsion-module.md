...
Let $R$ be an integral domain and $M$ an $R$-module. The module $M$ is a **torsion module** if every element of $M$ is a {{</* knowl id="torsion-element" text="torsion element" */>}}; equivalently, for each $m\in M$ there exists $0\ne r\in R$ with $rm=0$.
