...
Let $R$ be an {{< knowl id="integral-domain" text="integral domain" >}} and $M$ an $R$-{{< knowl id="module" text="module" >}}. The module $M$ is a **torsion module** if every element of $M$ is a {{< knowl id="torsion-element" text="torsion element" >}}; equivalently, for each $m\in M$ there exists $0\ne r\in R$ with $rm=0$.
