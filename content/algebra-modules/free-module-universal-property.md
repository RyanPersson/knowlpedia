...
This universal property characterizes {{< knowl id="free-module" text="free modules" >}} as the “linearizations” of {{< knowl id="set" text="sets" >}}, turning {{< knowl id="function" text="functions" >}} into {{< knowl id="module-homomorphism" text="module homomorphisms" >}} by unique extension.
