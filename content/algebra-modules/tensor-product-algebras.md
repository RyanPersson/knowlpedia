...
The **tensor product of algebras** \(A\otimes_R B\) of two \(R\)-algebras \(A,B\) over a {{< knowl id="commutative-ring" text="commutative ring" >}} \(R\) is the {{< knowl id="tensor-product" text="tensor product" >}} of the underlying \(R\)-modules, equipped with the unique \(R\)-algebra structure for which
\[
...
**Examples:**
- Over a field \(k\), one has \(k[x]\otimes_k k[y]\cong k[x,y]\) as \(k\)-algebras, where \(k[x]\) is a {{< knowl id="polynomial-ring" text="polynomial ring" >}}.
- If \(S\) is an \(R\)-algebra and \(I\subseteq R\) is an {{< knowl id="ideal" text="ideal" >}}, then \(S\otimes_R (R/I)\cong S/IS\) as \(R\)-algebras.
