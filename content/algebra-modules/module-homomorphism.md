...
Let $M,N$ be left $R$-{{</* knowl id="module" text="modules" */>}}. A **module homomorphism** is a {{</* knowl id="function" text="function" */>}} $f:M\to N$ such that for all $m,m'\in M$ and $r\in R$,
\[
...
Module homomorphisms compose (see {{</* knowl id="composition" text="composition" */>}}), and their basic invariants are the {{</* knowl id="kernel-module" text="kernel" */>}} and {{</* knowl id="image-module" text="image" */>}}, which control exactness and quotients.
