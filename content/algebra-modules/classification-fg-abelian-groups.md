...
This is obtained by applying the {{</* knowl id="structure-theorem-pid" text="structure theorem over a PID" */>}} to the {{</* knowl id="pid" text="PID" */>}} $\mathbb Z$: a finitely generated abelian group is a {{</* knowl id="finitely-generated-module" text="finitely generated module" */>}} and decomposes as a {{</* knowl id="direct-sum-modules" text="direct sum" */>}} of {{</* knowl id="cyclic-module" text="cyclic" */>}} pieces.
