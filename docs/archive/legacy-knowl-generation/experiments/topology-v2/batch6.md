...
**Current section (topology-baire) - no section param needed:**
baire-space, baire-category-theorem, nowhere-dense-set, meager-set, residual-set, complete-metric-space-is-baire, intersection-of-dense-open-is-dense, category-argument-template
