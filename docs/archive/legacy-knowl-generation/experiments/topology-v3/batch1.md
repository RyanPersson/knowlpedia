...
**Current section (topology-core) - no section param needed:**
topological-space, topology, topology-axioms, open-set, closed-set, interior, closure, neighborhood, limit-point-accumulation-point-cluster-point, derived-set, dense-set, dense-subset, subspace-topology, continuous-map, continuity-via-open-sets, homeomorphism, basis-of-a-topology, topology-generated-by-basis, subbasis-of-a-topology, product-topology, quotient-topology, cover
