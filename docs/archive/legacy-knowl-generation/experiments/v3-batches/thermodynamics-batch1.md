...
- corollary-carnot-absolute-temperature
- gibbs-duhem-theorem
- kelvin-planck-clausius-equivalence
- maxwell-relations-theorem
- prop-entropy-concavity-energy
- prop-free-energy-convexity-temperature
- prop-grand-canonical-particle-number
- subadditivity-partition-function
- superadditivity-entropy
- thermodynamic-limit-pressure-existence