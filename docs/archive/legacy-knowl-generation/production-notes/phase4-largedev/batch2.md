...
probability-space, probability-measure, random-variable, expectation, iid-sequence, moment-generating-function, distribution-law, relative-entropy-kl-divergence

**convex-analysis (use section="convex-analysis"):**
convex-conjugate-fenchel, legendre-fenchel-transform, convex-set

**measure-theory (use section="measure-theory"):**
measure-space, lebesgue-integral
