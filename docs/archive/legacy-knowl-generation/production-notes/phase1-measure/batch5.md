...
almost-everywhere, borel-sigma-algebra, lebesgue-measure, measurable-function, measurable-set, measurable-space, measure, measure-space, null-set, sigma-algebra, simple-function, lebesgue-integral, l1-function, lp-space, lp-norm, product-measure

**shared-foundations (use section="shared-foundations"):**
function, set, subset, sequence, cartesian-product

**real-analysis (use section="real-analysis"):**
supremum, infimum, limit-of-a-sequence
