...
almost-everywhere, borel-sigma-algebra, lebesgue-measure, measurable-function, measurable-set, measurable-space, measure, measure-space, null-set, sigma-algebra, simple-function, ae-equality, lebesgue-integrable-function, lebesgue-integral-nonnegative, lebesgue-integral, l1-function

**shared-foundations (use section="shared-foundations"):**
function, set, subset, union, intersection, cartesian-product, sequence, countable-set, bijective-function, supremum, infimum

**real-analysis (use section="real-analysis"):**
supremum, infimum, limit-of-a-sequence, convergent-series, absolute-value, interval, bounded-above, bounded-below

**All slugs being generated in this phase (measure-theory, no section param):**
