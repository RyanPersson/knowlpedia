...
The compiler branch adds safe standard Markdown navigation links so the 1,170-page
corpus index does not eagerly embed every target fragment.
...
at /conjectures/formal-conjectures-corpus/. It contains 1,170 navigation links:
...
- Browser QA: all 1,170 corpus navigation links present; representative generated
  page rendered 17 KaTeX nodes; no missing targets, raw math, or horizontal overflow
