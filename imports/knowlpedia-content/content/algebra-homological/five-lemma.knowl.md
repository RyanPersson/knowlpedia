...
title = "Five lemma"
kind = "knowl"
summary = "In a morphism of exact sequences, if four vertical maps are isomorphisms (with mild extra hypotheses), then so is the middle map."
aliases = ["five-lemma", "Five lemma"]
domains = ["algebra-homological"]
legacy_source_path = "algebra-homological/five-lemma.md"
+++

The five lemma is a standard diagram-chase tool in \(R\)-modules and, more generally, in any [[algebra-category-theory/abelian-category|abelian category]]. It strengthens the injectivity/surjectivity conclusions of the [[algebra-homological/four-lemma|four lemma]] and is often used alongside the [[algebra-homological/snake-lemma|snake lemma]].
