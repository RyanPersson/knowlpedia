+++
id = "fiber-bundles/hopf-fibration-s3s2-as-a-principal-u-bundle"
...
3. **Natural connection.**
   The Hopf bundle carries a canonical principal connection whose curvature is a multiple of the area form on the base; this is the geometric starting point for the [[fiber-bundles/dirac-monopole-connection-on-the-hopf-bundle|Dirac monopole connection]].
