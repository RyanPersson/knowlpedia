...
kind = "knowl"
summary = "The derivative {L}_X of a form along a vector field , characterized by Cartan’s formula."
...
Let \(M\) be a [[fiber-bundles/smooth-manifold|smooth manifold]] and let \(X\) be a [[fiber-bundles/vector-field|vector field]] on \(M\). The **Lie derivative** differentiates tensor fields, and in particular [[fiber-bundles/differential-k-form|differential forms]], along the flow of \(X\).
