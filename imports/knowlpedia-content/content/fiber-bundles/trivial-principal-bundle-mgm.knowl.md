+++
id = "fiber-bundles/trivial-principal-bundle-mgm"
...
Let $M$ be a [[fiber-bundles/smooth-manifold|smooth manifold]] and let $G$ be a [[fiber-bundles/lie-group|Lie group]]. The **trivial principal $G$-bundle** over $M$ is
\[
