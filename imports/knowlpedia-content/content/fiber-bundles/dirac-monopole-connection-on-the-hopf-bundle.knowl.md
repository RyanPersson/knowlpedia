...
A **Dirac monopole connection** is a [[fiber-bundles/principal-connection|principal connection]] on $\pi:S^3\to S^2$ whose curvature 2-form on the base represents the generator of $H^2(S^2;\mathbb Z)$ under the usual normalization for circle bundles.
...
## Curvature
The [[fiber-bundles/curvature|curvature]] 2-form is globally well-defined on $S^2$ by
\[
