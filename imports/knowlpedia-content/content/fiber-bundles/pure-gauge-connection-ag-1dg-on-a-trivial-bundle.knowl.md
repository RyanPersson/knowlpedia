...
This $A$ is called a **pure gauge** potential because it is exactly the gauge transform of the [[fiber-bundles/flat-connection-a0-on-a-trivial-bundle|flat connection]] with $A=0$.
