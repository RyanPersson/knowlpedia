...
Let \(R\) be a [[algebra-commutative/noetherian-ring|Noetherian ring]]. Then for every \(n \ge 1\), the polynomial ring \(R[x_1,\dots,x_n]\) is Noetherian.
...
- In particular, if \(k\) is a [[algebra-rings/field|field]], then \(k[x_1,\dots,x_n]\) is Noetherian.
