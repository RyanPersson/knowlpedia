+++
id = "algebra-commutative/nullstellensatz-variety-correspondence"
...
2. **A point.**
   In $k[x,y]$, let $I=(x,y)$. Then $V(I)=\{(0,0)\}$. Conversely, for the closed set $X=\{(0,0)\}$ one has $I(X)=(x,y)$, a maximal ideal, matching the identification of [[algebra-commutative/maximal-spectrum|maximal ideals]] with points.
