+++
id = "algebra-commutative/semisimple-artinian-product"
...
A *semisimple Artinian ring* (see [[algebra-rings/artinian-semisimple-ring|semisimple Artinian ring]]) is, in particular, an [[algebra-commutative/artinian-ring|Artinian ring]] whose module theory has no nontrivial extensions. The structure theorem is a product decomposition into simple pieces.
