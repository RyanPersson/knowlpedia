+++
id = "algebra-commutative/going-up-theorem"
...
**Theorem (Going up).**
Assume $A\subseteq B$ is an [[algebra-commutative/integral-extension|integral extension]]. Let $\mathfrak p\subseteq \mathfrak p'$ be prime ideals of $A$, and let $\mathfrak q\in \operatorname{Spec}(B)$ satisfy $\mathfrak q\cap A=\mathfrak p$. Then there exists a prime ideal $\mathfrak q'\subseteq B$ such that
\[
