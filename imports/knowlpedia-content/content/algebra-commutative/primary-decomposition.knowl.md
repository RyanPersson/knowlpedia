+++
id = "algebra-commutative/primary-decomposition"
...
Primary decompositions do not exist in arbitrary rings. The fundamental existence theorem is the [[algebra-commutative/lasker-noether-theorem|Lasker–Noether theorem]], often packaged as [[algebra-commutative/noetherian-primary-decomposition|primary decomposition in Noetherian rings]]: if $R$ is a [[algebra-commutative/noetherian-ring|Noetherian ring]], then every ideal $I\subseteq R$ admits a primary decomposition.
