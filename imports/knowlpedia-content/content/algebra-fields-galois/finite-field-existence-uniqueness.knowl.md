...
Uniqueness can be seen by noting that every field with \(q\) elements is the [[algebra-fields-galois/splitting-field|splitting field]] of \(x^q-x\) over \(\mathbb{F}_p\), and splitting fields are unique up to \(\mathbb{F}_p\)-isomorphism.
