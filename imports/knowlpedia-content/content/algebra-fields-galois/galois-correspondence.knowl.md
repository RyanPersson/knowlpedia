+++
id = "algebra-fields-galois/galois-correspondence"
title = "Galois Correspondence"
kind = "knowl"
summary = "For a finite Galois extension, intermediate fields correspond bijectively to subgroups of the Galois group."
aliases = ["galois-correspondence", "Galois Correspondence"]
domains = ["algebra-fields-galois"]
legacy_source_path = "algebra-fields-galois/galois-correspondence.md"
+++

Let $L/K$ be a finite [[algebra-fields-galois/galois-extension|Galois extension]] with [[algebra-fields-galois/galois-group|Galois group]] $G = \mathrm{Gal}(L/K)$.

Let $\mathcal{I}(L/K)$ denote the set of [[algebra-fields-galois/intermediate-field|intermediate fields]] $E$ with $K\subseteq E\subseteq L$, and let $\mathrm{Sub}(G)$ be the set of subgroups of $G$.

For $E\in\mathcal{I}(L/K)$ define
\[
\Phi(E) = \mathrm{Gal}(L/E)=\{\sigma\in G:\sigma|_E=\mathrm{id}_E\},
\]
and for a subgroup $H\le G$ define its [[algebra-fields-galois/fixed-field|fixed field]]
\[
...
\]
which combine [[algebra-fields-galois/galois-degree-equals-group-order|degree = group order for finite Galois extensions]] with the [[algebra-fields-galois/tower-law|tower law]].

Finally, for $E\in\mathcal{I}(L/K)$ with corresponding subgroup $H=\mathrm{Gal}(L/E)$, the subextension $E/K$ is [[algebra-fields-galois/normal-extension|normal]] (equivalently, Galois) if and only if $H$ is a normal subgroup of $G$, and then restriction induces an isomorphism
\[
