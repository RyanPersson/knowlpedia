+++
id = "stat-mech/liouville-theorem"
title = "Liouville theorem (invariance of phase-space volume)"
kind = "knowl"
summary = "Hamiltonian time evolution preserves phase-space volume; equivalently, the Liouville measure dq dp is invariant under the Hamiltonian flow."
aliases = ["liouville-theorem", "Liouville theorem (invariance of phase-space volume)"]
domains = ["stat-mech"]
...
- The induced invariant reference measure underlies equilibrium ensembles; for example, the [[stat-mech/microcanonical-measure|microcanonical measure]] is stationary under Hamiltonian time evolution (assuming energy is conserved and appropriate regularity/ergodic assumptions are treated separately).
## significance/proof
