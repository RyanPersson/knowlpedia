+++
id = "stat-mech/lee-yang-extensions"
title = "Lee–Yang Theorem and Extensions"
kind = "knowl"
summary = "Lee–Yang location of partition-function zeros for ferromagnets and the notion of the Lee–Yang property; consequences for analyticity and phase transitions."
aliases = ["lee-yang-extensions", "Lee–Yang Theorem and Extensions"]
domains = ["stat-mech"]
...
- [[stat-mech-lattice/finite-volume-gibbs-measure|finite-volume Gibbs measures]]
- [[stat-mech-lattice/phase-transition-gibbs|phase transitions for Gibbs measures]]
- [[stat-mech-lattice/tfae-phase-transition-indicators|phase transition indicators]]
- [[stat-mech-lattice/spontaneous-magnetization|spontaneous magnetization]]
...
- In ferromagnets, non-analyticity in the thermodynamic limit can only occur through an accumulation of zeros approaching the real axis. The Lee–Yang picture therefore links:
  ...
  - and the emergence of [[stat-mech-lattice/spontaneous-magnetization|spontaneous magnetization]]
  (see also [[stat-mech-lattice/tfae-phase-transition-indicators|phase transition indicators]]).
...
- and information about critical behavior from the way zeros approach the real axis in the thermodynamic limit (again aligning with [[stat-mech-lattice/tfae-phase-transition-indicators|phase transition indicators]]).
