+++
id = "stat-mech/corollary-kms-imaginary-time-periodicity"
title = "KMS imaginary-time periodicity"
kind = "knowl"
summary = "For a β-KMS equilibrium state, real-time correlation functions extend analytically to a complex-time strip and satisfy a β-periodicity (KMS boundary) relation in imaginary time."
aliases = ["corollary-kms-imaginary-time-periodicity", "KMS imaginary-time periodicity"]
domains = ["stat-mech"]
...
- $\omega$ is a $\beta$-KMS state for $\tau_t$ ([[stat-mech-quantum/kms-condition-finite|KMS condition]]).
...
- The equilibrium notion here is the [[stat-mech-quantum/kms-condition-finite|KMS condition]].
